...
<head>
    <title>IMST IT-Inventory | Login</title>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates/login') }}/vendor/bootstrap/css/bootstrap.min.css">
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css"
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates/alert') }}/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css"
...
<body>
    ...
    <div class="limiter">
        <div class="container-login100 image-login">
            <div class="wrap-login100">
                <div class="login100-form-title image-login1">
