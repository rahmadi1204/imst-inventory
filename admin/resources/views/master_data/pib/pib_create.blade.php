                                                    ...
                                                    <div class="card-body">
                                                        <table class="table table-bordered table-hover">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <th>BM</th>
                                                                    <td><input type="number" name="bm_paid"
                                                                            class="form-control"></td>
                                                                    <td><input type="number" name="bm_borne"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="bm_delay"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="bm_taxfree"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="bm_free"
                                                                            class="form-control">
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <th>BM KITE</th>
                                                                    <td><input type="number" name="bm_kitte_paid"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="bm_kitte_borne"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="bm_kitte_delay"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="bm_kitte_taxfree"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="bm_kitte_free"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="bm_kitte_paidoff"
                                                                            class="form-control">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th>BMT</th>
                                                                    <td><input type="number" name="bmt_paid"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="bmt_borne"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="bmt_delay"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="bmt_taxfree"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="bmt_free"
                                                                            class="form-control">
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <th>PPN</th>
                                                                    <td><input type="number" name="ppn_paid"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="ppn_borne"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="ppn_delay"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="ppn_taxfree"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="ppn_free"
                                                                            class="form-control">
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <th>PPh</th>
                                                                    <td><input type="number" name="pph_paid"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="pph_borne"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="pph_delay"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="pph_taxfree"
                                                                            class="form-control">
                                                                    </td>
                                                                    <td><input type="number" name="pph_free"
                                                                            class="form-control">
                                                                    </td>
