<script>
    ...
    $('#no_ref').change(function() {
        let code = $(this).val();
        let code_supplier = $('#no_ref option:selected').attr("code_supplier");
        let name = $('#no_ref option:selected').attr("name_supplier");
...
<script type="text/javascript">
    ...
    $("#dynamic-pr").click(function() {
        ++j;
        $("#productAddRemove1").append('<tr><td><select name="code_product[' + j +
            ']" id="code_product' +
            j +
